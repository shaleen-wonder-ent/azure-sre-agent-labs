...
GRUBIFY_REPO="https://github.com/shaleen-wonder-ent/grubify.git"
...
TASK_BODY=$($PYTHON -c "
import json, os
repo = os.environ.get('GITHUB_REPO', 'shaleen-wonder-ent/grubify')
...
if command -v gh &>/dev/null && gh auth status &>/dev/null 2>&1; then
  ...
  echo "   1. Fork https://github.com/shaleen-wonder-ent/grubify"
