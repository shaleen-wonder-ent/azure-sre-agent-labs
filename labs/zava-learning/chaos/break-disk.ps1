...
# No manual paging: the Zava-grade-exports-failing Azure Monitor rule detects the symptom from the
# reporting-worker VM Syslog and the SRE Agent picks it up as an incident.
