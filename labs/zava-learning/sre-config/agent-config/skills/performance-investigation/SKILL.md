...
by the `pr-delivery` skill.

## Incident communication
Record your diagnostic notes and status in the incident thread and the report. Azure Monitor tracks
the alert lifecycle and auto-resolves it on recovery.
