...
Sensitive data must NEVER appear in any operator-visible surface: the incident thread/chat, commit
messages or pull-request bodies, or any report artifact (HTML, PowerPoint, Teams card). This is the
canonical, deterministic scrub. Retrieve it with
